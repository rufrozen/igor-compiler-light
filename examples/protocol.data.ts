...
{
    return selectOptions(SomeEnum.Count, key, SomeEnumToString, value, SomeEnumToDescription);
}
...
{
    return selectOptions(GlobalEnum.Count, key, GlobalEnumToString, value, GlobalEnumToDescription);
}
...
{
    return selectOptions(BigInnerRecordStatusEnum.Count, key, BigInnerRecordStatusEnumToString, value, BigInnerRecordStatusEnumToDescription);
}
...
{
    return selectOptions(BigInnerRecordCustomEnum.Count, key, BigInnerRecordCustomEnumToString, value, BigInnerRecordCustomEnumToDescription);
}
...
{
    return selectOptions(DeleteSecondRequestBodyItemEnum.Count, key, DeleteSecondRequestBodyItemEnumToString, value, DeleteSecondRequestBodyItemEnumToDescription);
}
